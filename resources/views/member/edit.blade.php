        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">Actualizar Miembro</span>
                    </div>
            ...
            <div class="col-md-6">
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        <img id="output_picture" class=""  style="width: 100%;height: 100%;" src="{{$member->photo=="" ? asset('img/default.png'):asset('img/uploads/'.$member->photo)}}">
                    </div>
                </div>
